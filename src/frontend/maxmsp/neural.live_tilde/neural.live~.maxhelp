...
, 							{
								"box" : 								{
									...
									"text" : "mcs.neural.live~ wheel decode 3"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "mcs.neural.live~ wheel encode 3"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "mc.neural.live~ wheel decode"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "mc.neural.live~ wheel encode"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "neural.live~ has two multi-channel versions : \n     - mc.neural.live~ that batches inputs among mc channels\n     - mcs.neural.live~ that batches inputs among inlets"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "neural.live~ wheel forward"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "neural.live~ wheel forward 8192"
								}
...
, 			{
				"name" : "mc.neural.live~.mxo",
				"type" : "iLaX"
			}
, 			{
				"name" : "mcs.neural.live~.mxo",
				"type" : "iLaX"
			}
, 			{
